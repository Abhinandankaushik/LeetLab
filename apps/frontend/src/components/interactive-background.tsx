...
export const InteractiveBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      // Use the document's client width (excludes the vertical scrollbar) so the
      // fixed canvas never spills past the content area and triggers horizontal
      // overflow. `innerWidth` includes the scrollbar and would be too wide.
