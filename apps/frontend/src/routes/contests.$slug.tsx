...
export default function ContestDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-12 stagger">
      ...
      <section className="mb-16">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 border-b border-border/40 pb-10">
          <div className="flex-1">
             ...
             <h1 className="font-display text-3xl sm:text-4xl md:text-6xl font-black tracking-tight text-foreground mb-6">
                {contest?.name}
             </h1>
