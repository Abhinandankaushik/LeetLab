  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 stagger min-h-screen">
      ...
      <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <Button variant="ghost" size="sm" asChild className="self-start rounded-full gap-2 text-muted-foreground hover:text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 lg:gap-12">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black tracking-tighter text-foreground leading-none break-words">
              {playlist.name}
            </h1>
