...
export default function DiscussPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 md:py-10 stagger min-h-screen">
      {/* Premium Header Section */}
      <div className="mb-8 md:mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
             <div className="h-1 w-8 bg-primary rounded-full" />
             <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-primary font-bold">Community Forum</p>
          </div>
          <h1 className="font-display text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter leading-none">
