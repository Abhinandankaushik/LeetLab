...
import { Terminal, Sparkles, UserPlus, ArrowRight, Zap, Eye, EyeOff } from "lucide-react";
...
`} />
            ...
            <div
              className="absolute right-2 -top-5 rounded-xl border border-accent/40 bg-card/90 p-4 shadow-xl backdrop-blur"
            ...
            <div
              className="absolute -bottom-5 left-2 rounded-xl border border-primary/40 bg-card/90 p-4 shadow-xl backdrop-blur"
              style={{ transform: "translateZ(40px) rotateY(12deg)" }}
            >
              <div className="flex items-center gap-2 font-mono text-xs">
        ...
        <div className="w-full max-w-sm animate-fade-in-up lg:ml-auto">
          ...
          <h1 className="mt-1.5 font-display text-3xl font-bold animate-slide-in-right" style={{ animationDelay: "0.1s" }}>Join the lab</h1>
