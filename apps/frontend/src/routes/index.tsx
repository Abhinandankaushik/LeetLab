  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="absolute -left-16 sm:-left-32 top-0 h-48 w-48 sm:h-96 sm:w-96 rounded-full bg-primary/10 blur-3xl animate-pulse-glow" />
        <div className="absolute -right-16 sm:-right-32 bottom-0 h-48 w-48 sm:h-96 sm:w-96 rounded-full bg-accent/10 blur-3xl animate-pulse-glow" style={{ animationDelay: "2s" }} />
        <div className="relative z-10 mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:py-16 lg:grid-cols-[1.2fr_1fr] lg:gap-12 lg:py-28">
          <div className="relative text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-bold leading-[1.05] tracking-tight md:text-7xl">
          ...
          <div className="relative perspective-1000">
            <div className="animate-float relative preserve-3d" style={{ transform: "rotateY(-8deg) rotateX(4deg)" }}>
              ...
              <div
                className="absolute right-2 -top-5 hidden rounded-xl border border-primary/40 bg-card/90 p-3 shadow-xl backdrop-blur md:block"
              ...
              <div
                className="absolute -bottom-5 left-2 hidden rounded-xl border border-accent/40 bg-card/90 p-3 shadow-xl backdrop-blur md:block"
                style={{ transform: "translateZ(40px) rotateY(-8deg)" }}
              >
                <div className="flex items-center gap-2 font-mono text-xs">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:py-20">
        <div className="mb-10 md:mb-12 max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-2xl sm:text-3xl md:text-4xl font-bold">One ecosystem. Zero limits.</h2>
        </div>
      ...
      <section className="border-t border-border/60 bg-muted/20">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 px-4 py-12 md:py-20 text-center">
          <h2 className="max-w-2xl font-display text-2xl sm:text-4xl font-bold md:text-5xl">
            Don't just code.<br />
