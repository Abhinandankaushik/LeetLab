          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-border bg-card/50 p-6">
               ...
               <div className="flex flex-col items-center justify-center h-[250px]">
                 <div className="text-4xl sm:text-5xl md:text-6xl font-black text-primary">+{analytics?.userGrowth || 0}</div>
      ...
      {tab === "analytics" && (
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-border bg-card p-6">
             ...
             <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-xs font-bold mt-4">
             ...
             <div className="space-y-4">
                {analytics?.popularProblems?.map((p: any, i: number) => (
                  <div key={i} className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-4 w-full sm:w-auto sm:flex-1 sm:max-w-[200px] sm:ml-4">
