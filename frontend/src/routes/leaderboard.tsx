...
export default function LeaderboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 stagger min-h-screen">
      {/* Premium Header */}
      <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
        ...
        <div className="flex items-center gap-1 rounded-2xl border border-border/60 bg-card/40 p-1.5 backdrop-blur-sm shadow-xl">
      ...
      {/* Advanced Podium */}
      {entries.length >= 3 && (
        <div className="mb-20 grid grid-cols-1 md:grid-cols-3 gap-8 items-end px-4">
        ...
        <div className="overflow-hidden rounded-[32px] border border-border/60 bg-card/40 shadow-2xl backdrop-blur-md">
          <div className="relative w-full overflow-x-auto scrollbar-thin scrollbar-thumb-primary/20">
            <div className="min-w-[800px] md:min-w-full">
              <div className="grid grid-cols-[100px_1fr_140px_140px_140px] gap-4 border-b border-border/60 bg-muted/20 px-8 py-5 font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold">
                <span>Rank</span>
              ...
              {entries.map((e) => (
                <Link
                  ...
                  className="grid grid-cols-[100px_1fr_140px_140px_140px] items-center gap-4 border-b border-border/40 px-8 py-5 last:border-0 hover:bg-primary/[0.03] transition-all group"
                >
                  <RankBadge rank={e.rank} />
                  <div className="flex items-center gap-4">
                    <Avatar className="h-10 w-10 border border-border/60 group-hover:border-primary/40 transition-colors">
