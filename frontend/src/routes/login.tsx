...
import { Terminal, Flame, Trophy, ArrowRight, ShieldCheck } from "lucide-react";
...
`} />
            ...
            <div
              className="absolute -right-6 -top-6 rounded-xl border border-primary/40 bg-card/90 p-4 shadow-xl backdrop-blur"
            ...
            <div
              className="absolute -bottom-6 -left-6 rounded-xl border border-accent/40 bg-card/90 p-4 shadow-xl backdrop-blur"
              style={{ transform: "translateZ(40px) rotateY(12deg)" }}
            >
              <div className="flex items-center gap-2 font-mono text-xs">
        ...
        <div className="w-full max-w-md animate-fade-in-up lg:ml-auto">
          ...
          <h1 className="mt-2 font-display text-5xl font-bold animate-slide-in-right" style={{ animationDelay: "0.1s" }}>Sign in</h1>
